...
# ---------------------------------------------------------
# Export selected reference sheets to CSV
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# Create GitHub-readable Population Specification
# ---------------------------------------------------------

population_spec <- read_excel(
  input_file,
  sheet = "Population_Spec",
  col_names = FALSE
)
...
writeLines(
  population_md,
  file.path(output_dir, "population_spec.md")
)

message("Reference CSVs and population_spec.md exported successfully.")